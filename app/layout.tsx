...
export const metadata: Metadata = {
  ...
  title: {
    default: "Fredrick Akojuru | Full Stack Developer & Agency Founder | Web Development Nigeria",
    template: "%s | Fredrick Akojuru - Web Developer & Tech Entrepreneur",
  },
  description:
    "Expert full stack developer and founder of AlienDev Agency in Nigeria. Specializing in React, Next.js, and custom web solutions for businesses across Africa and globally.",
  verification: {
  ...
  openGraph: {
    ...
    locale: "en_US",
    url: baseUrl,
    title: "Fredrick Akojuru | Full Stack Developer & Agency Founder | AlienDev Nigeria",
    description:
      "Professional web development services by Fredrick Akojuru, expert full stack developer and founder of AlienDev Agency based in Nigeria. Delivering custom web solutions, e-commerce, and mobile applications.",
    siteName: "Fredrick Akojuru - Professional Portfolio & AlienDev Agency",
    images: [
      {
  ...
  twitter: {
    ...
    title: "Fredrick Akojuru | Full Stack Developer & AlienDev Agency Founder",
    description:
      "Expert web development services by Fredrick Akojuru. Specializing in React, Next.js, and custom solutions for businesses in Nigeria and globally.",
    creator: "@fredrickakojuru",
